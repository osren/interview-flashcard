...
> ⚠️ 本文档已对人员姓名、ldap 等做脱敏处理；客户名保留在需求标题中便于业务回溯。
...
> 用户身份：本人账号（部门：商旅体验；岗位：实习生）
> 过滤规则：`relatedLdapList = <本人账号>`
>
...
|------|------|------|----------|----------|----------|
| [R-QYJ-581052](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-581052) | 【产研】酒店返佣结算线上化需求 | 已上线 | PM 同事×3 | RD 同事 | 2026-07-06 19:25 |
| [R-QYJ-650701](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-650701) | 瑞斯康达【差旅节省奖励-支持抵扣用车（因公-个付+因私）】 | 已上线 | PM 同事×2 | RD 同事 | 2026-07-06 10:23 |
| [R-QYJ-664379](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-664379) | 【礼来中国】用车 HCP 出行人需求 | 开发中 | PM 同事 | RD 同事 | 2026-07-06 10:11 |
...
|------|------|------|----------|----------|
| [T-QYJ-541767](https://ddp.intra.xiaojukeji.com/issue/story/T-QYJ-541767) | 2026商旅前端自驱体验优化 | 开发中 | RD 同事 | 2026-07-06 17:54 |
...
|------|------|------|----------|----------|----------|
| [R-QYJ-581052](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-581052) | 【产研】酒店返佣结算线上化需求 | 已上线 | PM 同事×3 | RD 同事 | 2026-07-06 19:25 |
| [R-QYJ-650701](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-650701) | 瑞斯康达【差旅节省奖励-支持抵扣用车】 | 已上线 | PM 同事×2 | RD 同事 | 2026-07-06 10:23 |
| [R-QYJ-664379](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-664379) | 【礼来中国】用车 HCP 出行人需求 | 开发中 | PM 同事 | RD 同事 | 2026-07-06 10:11 |
| [R-QYJ-643584](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-643584) | 【洁柔】申请单修改可更新差标 | 已上线 | PM 同事 | RD 同事 | 2026-07-03 17:30 |
| [R-QYJ-615835](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-615835) | 【洁柔】差旅申请单限额不占用机、酒、火服务费 | 已上线 | PM 同事 | RD 同事 | 2026-07-03 17:27 |
| [R-QYJ-620996](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-620996) | 国内机票接入"凤凰知音"常旅客计划会员接口 | 已上线 | PM 同事×2 | RD 同事 | 2026-07-03 14:18 |
| [R-QYJ-676539](https://ddp.intra.xiaojukeji.com/requirement/story/R-QYJ-676539) | 【国内机票】价格排序增加贴差标规则-二期 | 已排期 (P0) | PM 同事 | RD 同事 | 2026-07-01 17:22 |

> 注：本表为 jiazi 口径。机火预订端交付见下文「四、机火预订端交付」。
...
|------|------|------|----------|----------|
| [T-QYJ-541767](https://ddp.intra.xiaojukeji.com/issue/story/T-QYJ-541767) | 2026商旅前端自驱体验优化 | 开发中 | RD 同事 | 2026-07-06 17:54 |
| [T-QYJ-589521](https://ddp.intra.xiaojukeji.com/issue/story/T-QYJ-589521) | 【洁柔】申请单修改可更新差标 | 已上线 | RD 同事 | 2026-07-02 12:54 |
| [T-QYJ-606132](https://ddp.intra.xiaojukeji.com/issue/story/T-QYJ-606132) | 【国内机票】价格排序增加贴差标规则-二期 | 已排期 | RD 同事 | 2026-07-01 17:22 |
| [T-QYJ-583766](https://ddp.intra.xiaojukeji.com/issue/story/T-QYJ-583766) | 【苏美达集团】协议酒店增加logo或文案 | 已上线 | RD 同事 | 2026-07-01 10:05 |
...
| **T-QYJ-541767** 2026商旅前端自驱体验优化（开发中，RD Owner（同事）） | 本周 `feat_hcpTraveler` 多次合并 master 的部分工作可纳入自驱优化范畴 |
...
## 四、机火预订端交付（补录 · 2026.06 底—07 底）

> 原 W27 周报仅统计 `tech-esfe/jiazi`，未收录预订端仓库。以下按 PRD 与交付事实补录。  
> 核心仓库：机票 `fe-esflight` · 火车票 `fe-estrain`（滴滴企业版商旅核心品类，H5 / 小程序多端）。  
> 本人负责品类侧：**机票两条 + 火车票一条**；需求为机酒火多品类时不夸成全品类独做。

### 4.1 交付一览（均已上线）

| # | 需求名称 | 望岳 / 关联 | 仓库 | 本人范围 | 开发周期 | 状态 |
|---|----------|-------------|------|----------|----------|------|
| 1 | **多品类分享场景**（场景化分享扩入口） | R-QYJ-659181 / 商旅场景化分享 | `fe-esflight` | **机票侧** | 2026.06 底—07 中 | ✅ 已上线 |
| 2 | **差异化能力建设 · 超标次数预警** | R-QYJ-584930 | `fe-esflight` | **机票侧** | 2026.06 底—07 中 | ✅ 已上线 |
| 3 | **订单联系人手机号联动出行人** | R-QYJ-647976（代客下单联系人选号） | `fe-estrain` | **火车票侧** | 2026.07 中—07 底 | ✅ 已上线 |

### 4.2 多品类分享场景（机票 · `fe-esflight`）

**背景**：一期仅订单详情分享，日均 UV 约 1.7w、点击率约 0.3%；需在不干扰主决策前提下扩大感知，带动同事预订。

**本人机票侧工作**：

| 页面 | 内容 |
|------|------|
| 预订成功页 | 底部「邀请同事」；机/火按钮文案：回首页、订返程、查详情、邀请同事；望月 pid 控激励 icon |
| 订单详情 | banner「邀请同事预订」；过起飞时间不展示 |
| 订单列表 | 卡片底部分享；有/无激励文案区分 |
| 商品详情 | 右上角分享；卡片文案「这趟航班不错…」；失效兜底页 |
| 屏蔽规则 | 改签&多人订单；改签&假中转；往返日期异常不屏蔽入口、预订时拦截 |
| 埋点 | `es_share_book_sw` / `es_share_book_ck`，place：成功页=2、详情=5、列表=8、商品详情=11 |
| 放量 | 配合分享功能由白名单改黑名单策略 |

### 4.3 超标次数预警（机票 · `fe-esflight`）

**背景**：TMC 需人维度跨品类超标提醒，形成差异化管控；一期先做超标次数/排名预警弹窗。

**本人机票侧工作**：

| 项 | 说明 |
|----|------|
| 统计口径 | 预订人维度；行程触发 RC 且企业支付成功计入；混付/个付不计入；退票不减次数 |
| 触发点 | 航班报价页点超标报价「预订」；填单页变更乘机人后提交（前序未弹过）；改签选航班 |
| 防打扰 | 同一预订行为最多弹 1 次（bookingSessionId 或同品类 30 分钟频控） |
| 文案 | 次数版 / 排名版（近 30 天，T+1） |
| 端 | APP / H5 / 小程序 / PC（与品类规则对齐） |

### 4.4 联系人手机号联动出行人（火车 · `fe-estrain`）

**背景**：代客下单时客服需手工把联系电话改为出行人号码（如某大客户公转私场景），低效易错；明文传号有安全风险。目标：填单页快捷选出行人手机号。
...
|----|------|
| 页面 | 主端填单页 + 代客下单页 |
| 流程 | 联系人手机号旁「选择」→ 弹窗列出当前**已选出行人** → 选中回填（脱敏展示，完整号写入可再编辑）→ 关弹窗继续提交 |
| 边界 | 未选出行人 toast「请先选择出行人」；手机号缺失展示「手机号缺失」置灰不可选；无可用人员空态；回填后沿用 11 位校验 |
| 约束 | 不改关联人员档案；统一脱敏交互 |

### 4.5 与 jiazi 工作的关系

| 维度 | jiazi（甲子后台） | fe-esflight / fe-estrain（预订端） |
|------|-------------------|-------------------------------------|
| 角色 | 配置中台 B 端 | 机火核心预订 C 端 |
| 7 月主线 | HCP、实验排序搭建 | 分享 / 超标预警 / 联系人选号 **已上线** |
| 统计 | W27 原文 git 已覆盖 | **本节能补录；简历与面试以此为准** |
...
| 章节 | 数据来源 | 本周状态 | 后续行动 |
|------|----------|---------|---------|
| 一、代码工作 | 本地 `git log`（jiazi） | ✅ 已采集 | — |
| 二、望岳需求与任务 | `ddp`（jiazi 相关） | ✅ 已采集 | — |
| 三、产物与素材 | 工作区文件枚举 | ✅ 已采集 | — |
| 四、机火预订端交付 | PRD + 交付事实补录 | ✅ 2026-07-29 补录 | 可选：补 `fe-esflight`/`fe-estrain` git log |
| ~~Cooper / 会议 / 社区~~ | — | ⏸ 跳过 | — |
| 🔀 MR 状态 | `git-toy-mcp` | ❌ 未注册 | `glab mr list` 兜底 |

---

_生成时间：2026-07-07 11:31（W27 周报）_  
_补录：2026-07-29（第四节机火预订端）_  
_生成方式：Claude Code + weekly-report-skill；预订端为人工 PRD 补录_

---

# 累计工作回顾：本人 加入 jiazi 项目以来（2026-01-27 → 2026-07-07）

> 数据来源：`git log --all --author="<本人账号>" --since="2026-01-27"`，覆盖 tech-esfe/jiazi 仓库全部分支。  
> **另见上文「四、机火预订端交付」**：`fe-esflight` / `fe-estrain` 三条已上线需求（06 底—07 底）。  
> 时间窗：约 5 个半月。统计口径（甲子）：**160 次提交、16 个 feature 分支、15 个 release tag**。
...
### 第五阶段：报价实验 + 机火预订端（2026.06 底—07 底）

**甲子侧**
- 新模块 `src/pages/plane_price_rule/`（实验排序 List/Edit/Log/Service）
- HCP：`getInstitutionList` 对齐 + 制度弹窗/搜索 fix

**预订端（补录，均已上线）**
- `fe-esflight`：多品类分享（机票）、超标次数预警（机票）——06 底—07 中
- `fe-estrain`：联系人手机号联动出行人（火车）——07 中—07 底
...
| `feat_priceSort` (2 commits) | 已立项，基础路由已搭 | 对应 R-QYJ-676539（P0 **已排期**）；开发节奏与排期同步，与 PM 对应 PM / RD 同事对齐 |
...
| 跨域理解 | 机票政策 → 用车 → 供应商 → 资源 → 发票 → 会员；并进入 **机火 C 端预订链路** |
| 当前突破点 | 预订端三类场景已上线（增长/管控/代订提效）；甲子侧实验排序对接策略层 |

> 简历级一句话：5.5 个月甲子后台 160 commit / 16 feature / 15 release；同期在 `fe-esflight` / `fe-estrain` 交付分享、超标预警、联系人选号并上线。

## 8. 望岳（DDP）累计参与概览

> 数据来源：`ddp.searchRequirements` / `ddp.searchIssues`，过滤 `relatedLdapList = <本人账号>`，截至 2026-07-07（jiazi 快照）。  
> 预订端三条已在「四、机火预订端交付」专节收录，此处表格同步列出。

### 累计参与需求 — jiazi 范围（7 条）

| 序号 | 需求 | 状态 | 优先级 | 业务方向 | PM Owner | RD Owner | 最后更新 |
|------|------|------|--------|----------|----------|----------|----------|
| R-QYJ-581052 | 【产研】酒店返佣结算线上化需求 | 已上线 | 无 | 商旅出行产品部/财税产品 | PM 同事×3 | RD 同事 | 2026-07-06 |
| R-QYJ-650701 | 瑞斯康达【差旅节省奖励-支持抵扣用车】 | 已上线 | 无 | AE-在线交通/北区 | PM 同事×2 | RD 同事 | 2026-07-06 |
| R-QYJ-664379 | 【礼来中国】用车 HCP 出行人需求 | 开发中 | 无 | AE-网约出行/南区 | PM 同事 | RD 同事 | 2026-07-06 |
| R-QYJ-643584 | 【洁柔】申请单修改可更新差标 | 已上线 | 无 | AE-在线交通/南区 | PM 同事 | RD 同事 | 2026-07-03 |
| R-QYJ-615835 | 【洁柔】差旅申请单限额不占用机、酒、火服务费 | 已上线 | 无 | AE-在线交通/南区 | PM 同事 | RD 同事 | 2026-07-03 |
| R-QYJ-620996 | 国内机票接入"凤凰知音"常旅客计划会员接口 | 已上线 | 无 | 企业服务/商旅业务中心 | PM 同事×2 | RD 同事 | 2026-07-03 |
| R-QYJ-676539 | 【国内机票】价格排序增加贴差标规则-二期 | **已排期** | **P0** | 企业服务/商旅业务中心 | PM 同事 | RD 同事 | 2026-07-01 |

### 累计参与需求 — 机火预订端（3 条，补录）

| 序号 | 需求 | 状态 | 仓库 / 本人范围 | 周期 |
|------|------|------|-----------------|------|
| R-QYJ-659181 | 多品类分享场景 / 商旅场景化分享 | **已上线** | `fe-esflight` · 机票侧 | 06 底—07 中 |
| R-QYJ-584930 | 差异化能力建设-超标次数预警 | **已上线** | `fe-esflight` · 机票侧 | 06 底—07 中 |
| R-QYJ-647976 | 订单联系人联动出行人（代客下单选号） | **已上线** | `fe-estrain` · 火车票侧 | 07 中—07 底 |

### 累计参与任务（jiazi 范围，18 条）

| 序号 | 任务 | 状态 | 优先级 | RD Owner | 最后更新 |
|------|------|------|--------|----------|----------|
| T-QYJ-541767 | 2026商旅前端自驱体验优化 | 开发中 | P0 | RD 同事 | 2026-07-06 |
| T-QYJ-589521 | 【洁柔】申请单修改可更新差标 | 已上线 | 无 | RD 同事 | 2026-07-02 |
| T-QYJ-606132 | 【国内机票】价格排序增加贴差标规则-二期 | **已排期** | P0 | RD 同事 | 2026-07-01 |
| T-QYJ-583766 | 【苏美达集团】协议酒店增加logo或文案 | 已上线 | P0 | RD 同事 | 2026-07-01 |
| T-QYJ-589759 | 瑞斯康达【差旅节省奖励-支持抵扣用车】 | 已上线 | 无 | RD 同事 | 2026-06-30 |
| T-QYJ-602435 | 【礼来中国】用车 HCP 出行人需求 | 开发中 | 无 | RD 同事 | 2026-06-29 |
| T-QYJ-562788 | 国内机票接入"凤凰知音"常旅客计划会员接口 | 已上线 | 无 | RD 同事 | 2026-06-10 |
| T-QYJ-586093 | 【礼来中国】es管理后台项目（成员邮件提醒+按邮箱搜索） | 已上线 | 无 | RD 同事 | 2026-05-28 |
| T-QYJ-589481 | 国内酒店税负差服务费展示与预订支持 | 已上线 | 无 | RD 同事 | 2026-05-07 |
| T-QYJ-578948 | 【HLY】国内机票API退票流程改造 | 测试中 | 无 | RD 同事 | 2026-04-22 |
| T-QYJ-565043 | 【洁柔】差旅申请单限额不占用机、酒、火服务费 | 已上线 | 无 | RD 同事 | 2026-04-20 |
| T-QYJ-544336 | 国航直连二期-接入PC码产品 | 已上线 | 无 | RD 同事 | 2026-04-16 |
| T-QYJ-582431 | 甲子出租车开关保存加loading态 | 已上线 | 无 | **本人** | 2026-04-14 |
| T-QYJ-566608 | 甲子系统增加购票须知模块配置 | 已上线 | 无 | RD 同事 | 2026-04-01 |
| T-QYJ-553975 | 国内机票销售控制模块需求 | 已上线 | P0 | RD 同事 | 2026-03-25 |
| T-QYJ-553971 | 航司定投政策开发合作需求 | 已上线 | 无 | RD 同事 | 2026-03-18 |
| T-QYJ-545928 | 【德勤】支持ES后台加入新员工后自动发送员工定向邀请邮件 | 已上线 | 无 | RD 同事×2 | 2026-03-03 |
| T-QYJ-555409 | 【产研】酒店返佣结算线上化需求 | 已上线 | 无 | RD 同事 | 2026-02-26 |

### DDP 维度小结

- **作为 RD Owner 独立负责的任务**：1 条 — `T-QYJ-582431` 甲子出租车开关保存加loading态（已上线）
- **jiazi 需求**：7 条（5 上线 + 1 开发中 + 1 已排期）
- **预订端需求（补录）**：3 条 **全部已上线**（分享、超标预警、联系人选号）
- **jiazi 任务**：18 条（14 上线 / 1 测试中 / 3 开发或排期）
- **高频协作 RD**：机火方向 RD 同事等

## 9. 数据采集说明

- 甲子代码：`git -C /Users/didi/Desktop/jiazi log --all --author="<本人账号>" --since="2026-01-27"`
- 望岳：`ddp.searchRequirements` / `ddp.searchIssues`，`relatedLdapList=<本人账号>`
- **预订端补录**：依据 PRD + 交付事实写入「四、机火预订端交付」；仓库 `fe-esflight` / `fe-estrain` 的 commit 明细可后续用同口径 git log 补全
- 按指示曾跳过：Cooper 文档、会议纪要、社区动态
- 简历表述见：`滴滴实习经历简历版.md`

---
_追加生成时间：2026-07-07（累计工作回顾）_  
_补录时间：2026-07-29（机火预订端：分享 / 超标预警 / 联系人选号）_
