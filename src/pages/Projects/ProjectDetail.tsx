...
export function ProjectDetail() {
  ...
  const { updateCardStatus, getMergedCards, saveCardProgress, getCardProgress, addCustomCard, setLastVisitedProject } = useCardStore();
  ...
  }, [projectId, setLastVisitedProject]);
